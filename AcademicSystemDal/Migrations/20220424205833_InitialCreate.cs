    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BasicInfoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_BasicInfo_BasicInfoId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Students_UserProfile_UserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_BasicInfo_BasicInfoId",
                        column: x => x.BasicInfoId,
                        principalTable: "BasicInfo",
                        principalColumn: "BasicInfoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        principalColumn: "CourseId");
                    table.ForeignKey(
                        name: "FK_Teachers_Courses_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teachers_UserProfile_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfile",
                        principalColumn: "UserProfileId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DiciplinasDisciplineId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StudentsStudentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DisciplineStudents", x => new { x.DiciplinasDisciplineId, x.StudentsStudentId });
                    table.ForeignKey(
                        name: "FK_DisciplineStudents_Disciplines_DiciplinasDisciplineId",
                        column: x => x.DiciplinasDisciplineId,
                        principalTable: "Disciplines",
                        principalColumn: "DisciplineId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DisciplineStudents_Students_StudentsStudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DisciplineStudents_StudentsStudentId",
                table: "DisciplineStudents",
                column: "StudentsStudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Students_BasicInfoId",
                table: "Students",
                column: "BasicInfoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_UserProfileId",
                table: "Teachers",
                column: "UserProfileId");
        }
